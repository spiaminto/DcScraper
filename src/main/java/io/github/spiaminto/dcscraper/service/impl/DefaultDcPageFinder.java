...
public class DefaultDcPageFinder implements DcPageFinder {
    ...
    public void findPage(LocalDateTime inputDateTime, String galleryId, boolean isMinorGallery) {
        // 드라이버 켜기
...
//                    log.info("binarySearching else executeUrl = {}", executeUrl);
                    ...
                    stopWatch.stop();
                    log.info("[STOPWATCH] findFirstPageByDate : stopwatch.elapsed = {}", stopWatch.getTotalTimeSeconds());
